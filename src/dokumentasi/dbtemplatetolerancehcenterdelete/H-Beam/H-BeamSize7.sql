...
-- b1 (13-15)
('H.b1','TMP-rtxtuyv','H(b1)','number',13,13.5,14,14.5,15,NULL,13,1,'','b1','table'),
('C.b1','TMP-rtxtuyv','C(b1)','number',13,13.5,14,14.5,15,NULL,14,1,'','b1','table'),
('T.b1','TMP-rtxtuyv','T(b1)','number',13,13.5,14,14.5,15,NULL,15,1,'','b1','table'),

-- b3 (16-18)
('H.b3','TMP-rtxtuyv','H(b3)','number',13,13.5,14,14.5,15,NULL,16,1,'','b3','table'),
('C.b3','TMP-rtxtuyv','C(b3)','number',13,13.5,14,14.5,15,NULL,17,1,'','b3','table'),
('T.b3','TMP-rtxtuyv','T(b3)','number',13,13.5,14,14.5,15,NULL,18,1,'','b3','table'),

-- b2 (19-21)
('H.b2','TMP-rtxtuyv','H(b2)','number',13,13.5,14,14.5,15,NULL,19,1,'','b2','table'),
('C.b2','TMP-rtxtuyv','C(b2)','number',13,13.5,14,14.5,15,NULL,20,1,'','b2','table'),
('T.b2','TMP-rtxtuyv','T(b2)','number',13,13.5,14,14.5,15,NULL,21,1,'','b2','table'),

-- b4 (22-24)
('H.b4','TMP-rtxtuyv','H(b4)','number',13,13.5,14,14.5,15,NULL,22,1,'','b4','table'),
('C.b4','TMP-rtxtuyv','C(b4)','number',13,13.5,14,14.5,15,NULL,23,1,'','b4','table'),
('T.b4','TMP-rtxtuyv','T(b4)','number',13,13.5,14,14.5,15,NULL,24,1,'','b4','table'),

-- b1-b2/2 (25-27)
('H.b1-b2/2','TMP-rtxtuyv','H(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,25,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-rtxtuyv','C(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,26,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-rtxtuyv','T(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,27,1,'','b1-b2/2','table'),

-- b3-b4/2 (28-30)
('H.b3-b4/2','TMP-rtxtuyv','H(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,28,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-rtxtuyv','C(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,29,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-rtxtuyv','T(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,30,1,'','b3-b4/2','table'),

-- t1 (31-33)
('H.t1','TMP-rtxtuyv','H(t1)','number',13,13.5,14,14.5,15,NULL,31,1,'','t1','table'),
('C.t1','TMP-rtxtuyv','C(t1)','number',13,13.5,14,14.5,15,NULL,32,1,'','t1','table'),
('T.t1','TMP-rtxtuyv','T(t1)','number',13,13.5,14,14.5,15,NULL,33,1,'','t1','table'),

-- t3 (34-36)
('H.t3','TMP-rtxtuyv','H(t3)','number',13,13.5,14,14.5,15,NULL,34,1,'','t3','table'),
('C.t3','TMP-rtxtuyv','C(t3)','number',13,13.5,14,14.5,15,NULL,35,1,'','t3','table'),
('T.t3','TMP-rtxtuyv','T(t3)','number',13,13.5,14,14.5,15,NULL,36,1,'','t3','table'),

-- t2 (37-39)
('H.t2','TMP-rtxtuyv','H(t2)','number',13,13.5,14,14.5,15,NULL,37,1,'','t2','table'),
('C.t2','TMP-rtxtuyv','C(t2)','number',13,13.5,14,14.5,15,NULL,38,1,'','t2','table'),
('T.t2','TMP-rtxtuyv','T(t2)','number',13,13.5,14,14.5,15,NULL,39,1,'','t2','table'),

-- t4 (40-42)
('H.t4','TMP-rtxtuyv','H(t4)','number',13,13.5,14,14.5,15,NULL,40,1,'','t4','table'),
('C.t4','TMP-rtxtuyv','C(t4)','number',13,13.5,14,14.5,15,NULL,41,1,'','t4','table'),
('T.t4','TMP-rtxtuyv','T(t4)','number',13,13.5,14,14.5,15,NULL,42,1,'','t4','table'),

-- t5 (43-45)
('H.t5','TMP-rtxtuyv','H(t5)','number',8.3,8.65,9,9.35,9.7,NULL,43,1,'','t5','table'),
