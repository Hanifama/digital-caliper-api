...
('H.b1','TMP-rtxtuyx','H(b1)','number',11,11.5,12,12.5,13,NULL,13,1,'','b1','table'),
('C.b1','TMP-rtxtuyx','C(b1)','number',11,11.5,12,12.5,13,NULL,14,1,'','b1','table'),
('T.b1','TMP-rtxtuyx','T(b1)','number',11,11.5,12,12.5,13,NULL,15,1,'','b1','table'),

-- b3 (16-18)
('H.b3','TMP-rtxtuyx','H(b3)','number',11,11.5,12,12.5,13,NULL,16,1,'','b3','table'),
('C.b3','TMP-rtxtuyx','C(b3)','number',11,11.5,12,12.5,13,NULL,17,1,'','b3','table'),
('T.b3','TMP-rtxtuyx','T(b3)','number',11,11.5,12,12.5,13,NULL,18,1,'','b3','table'),

-- b2 (19-21)
('H.b2','TMP-rtxtuyx','H(b2)','number',11,11.5,12,12.5,13,NULL,19,1,'','b2','table'),
('C.b2','TMP-rtxtuyx','C(b2)','number',11,11.5,12,12.5,13,NULL,20,1,'','b2','table'),
('T.b2','TMP-rtxtuyx','T(b2)','number',11,11.5,12,12.5,13,NULL,21,1,'','b2','table'),

-- b4 (22-24)
('H.b4','TMP-rtxtuyx','H(b4)','number',11,11.5,12,12.5,13,NULL,22,1,'','b4','table'),
('C.b4','TMP-rtxtuyx','C(b4)','number',11,11.5,12,12.5,13,NULL,23,1,'','b4','table'),
('T.b4','TMP-rtxtuyx','T(b4)','number',11,11.5,12,12.5,13,NULL,24,1,'','b4','table'),

-- b1-b2/2 (25-27)
('H.b1-b2/2','TMP-rtxtuyx','H(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,25,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-rtxtuyx','C(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,26,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-rtxtuyx','T(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,27,1,'','b1-b2/2','table'),

-- b3-b4/2 (28-30)
('H.b3-b4/2','TMP-rtxtuyx','H(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,28,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-rtxtuyx','C(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,29,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-rtxtuyx','T(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,30,1,'','b3-b4/2','table'),

-- t1 (31-33) - PERUBAHAN: t1 datang setelah perhitungan b
('H.t1','TMP-rtxtuyx','H(t1)','number',11,11.5,12,12.5,13,NULL,31,1,'','t1','table'),
('C.t1','TMP-rtxtuyx','C(t1)','number',11,11.5,12,12.5,13,NULL,32,1,'','t1','table'),
('T.t1','TMP-rtxtuyx','T(t1)','number',11,11.5,12,12.5,13,NULL,33,1,'','t1','table'),

-- t3 (34-36)
('H.t3','TMP-rtxtuyx','H(t3)','number',11,11.5,12,12.5,13,NULL,34,1,'','t3','table'),
('C.t3','TMP-rtxtuyx','C(t3)','number',11,11.5,12,12.5,13,NULL,35,1,'','t3','table'),
('T.t3','TMP-rtxtuyx','T(t3)','number',11,11.5,12,12.5,13,NULL,36,1,'','t3','table'),

-- t2 (37-39)
('H.t2','TMP-rtxtuyx','H(t2)','number',11,11.5,12,12.5,13,NULL,37,1,'','t2','table'),
('C.t2','TMP-rtxtuyx','C(t2)','number',11,11.5,12,12.5,13,NULL,38,1,'','t2','table'),
('T.t2','TMP-rtxtuyx','T(t2)','number',11,11.5,12,12.5,13,NULL,39,1,'','t2','table'),

-- t4 (40-42)
('H.t4','TMP-rtxtuyx','H(t4)','number',11,11.5,12,12.5,13,NULL,40,1,'','t4','table'),
('C.t4','TMP-rtxtuyx','C(t4)','number',11,11.5,12,12.5,13,NULL,41,1,'','t4','table'),
('T.t4','TMP-rtxtuyx','T(t4)','number',11,11.5,12,12.5,13,NULL,42,1,'','t4','table'),

-- t5 (43-45)
('H.t5','TMP-rtxtuyx','H(t5)','number',11.3,11.65,12,12.35,12.7,NULL,43,1,'','t5','table'),
('C.t5','TMP-rtxtuyx','C(t5)','number',11.3,11.65,12,12.35,12.7,NULL,44,1,'','t5','table'),
('T.t5','TMP-rtxtuyx','T(t5)','number',11.3,11.65,12,12.35,12.7,NULL,45,1,'','t5','table'),

-- t6 (NULL) - 46-48 dengan order_numb NULL sesuai pola
('H.t6','TMP-rtxtuyx','H(t6)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t6','table'),
('C.t6','TMP-rtxtuyx','C(t6)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t6','table'),
('T.t6','TMP-rtxtuyx','T(t6)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t6','table'),

-- t7 (NULL) - 49-51 dengan order_numb NULL
('H.t7','TMP-rtxtuyx','H(t7)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t7','table'),
('C.t7','TMP-rtxtuyx','C(t7)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t7','table'),
('T.t7','TMP-rtxtuyx','T(t7)','number',11.3,11.65,12,12.35,12.7,NULL,NULL,1,'','t7','table'),
