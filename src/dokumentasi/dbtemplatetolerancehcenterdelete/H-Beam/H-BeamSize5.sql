...
('flange.thickness','TMP-rtxtuyt','Flange Thickness','number',11,11.5,12,12.5,13,0,53,1,'','FormRight','Flange Thickness'),
('width.of.web','TMP-rtxtuyt','Width of Web','number',198,199,200,201,202,0,54,1,'','FormRight','Width of Web'),
('web.thickness','TMP-rtxtuyt','Web Thickness','number',7.3,7.65,8,8.35,8.7,0,55,1,'','FormRight','Web Thickness'),
('unit.weight','TMP-rtxtuyt','Unit Weight (Kgm)','number',47.9,48.9,49.9,50.9,51.9,0,56,1,'','FormRight','Unit Weight (Kgm)'),
('radius','TMP-rtxtuyt','Radius','number',0,0,13,0,0,0,57,1,'','FormRight','Radius'),
('web.off.center','TMP-rtxtuyt','Web Off Center','number',-2.5,-1.25,0,1.25,2.5,0,58,1,'','FormRight','Web Off Center'),
('os','TMP-rtxtuyt','OS','number',0,0,2,0,0,0,59,1,'','FormRight','OS'),
('cow','TMP-rtxtuyt','CoW','number',0,0,0,0,0,2,60,1,'','FormRight','CoW');
