...
-- t1 (13-15)
('H.t1','TMP-rtxtryr','H(t1)','number',6.3,6.65,7,7.35,7.7,NULL,13,1,'','t1','table'),
('C.t1','TMP-rtxtryr','C(t1)','number',6.3,6.65,7,7.35,7.7,NULL,14,1,'','t1','table'),
('T.t1','TMP-rtxtryr','T(t1)','number',6.3,6.65,7,7.35,7.7,NULL,15,1,'','t1','table'),

-- t2 (16-18) 
('H.t2','TMP-rtxtryr','H(t2)','number',6.3,6.65,7,7.35,7.7,NULL,16,1,'','t2','table'),
('C.t2','TMP-rtxtryr','C(t2)','number',6.3,6.65,7,7.35,7.7,NULL,17,1,'','t2','table'),
('T.t2','TMP-rtxtryr','T(t2)','number',6.3,6.65,7,7.35,7.7,NULL,18,1,'','t2','table'),

-- t3 (19-21) 
('H.t3','TMP-rtxtryr','H(t3)','number',6.3,6.65,7,7.35,7.7,NULL,19,1,'','t3','table'),
('C.t3','TMP-rtxtryr','C(t3)','number',6.3,6.65,7,7.35,7.7,NULL,20,1,'','t3','table'),
('T.t3','TMP-rtxtryr','T(t3)','number',6.3,6.65,7,7.35,7.7,NULL,21,1,'','t3','table'),

-- t4 (22-24) 
('H.t4','TMP-rtxtryr','H(t4)','number',6.3,6.65,7,7.35,7.7,NULL,22,1,'','t4','table'),
('C.t4','TMP-rtxtryr','C(t4)','number',6.3,6.65,7,7.35,7.7,NULL,23,1,'','t4','table'),
('T.t4','TMP-rtxtryr','T(t4)','number',6.3,6.65,7,7.35,7.7,NULL,24,1,'','t4','table'),
...
-- b1 (28-30) 
('H.b1','TMP-rtxtryr','H(b1)','number',9,9.5,10,10.5,11,NULL,28,1,'','b1','table'),
('C.b1','TMP-rtxtryr','C(b1)','number',9,9.5,10,10.5,11,NULL,29,1,'','b1','table'),
('T.b1','TMP-rtxtryr','T(b1)','number',9,9.5,10,10.5,11,NULL,30,1,'','b1','table'),

-- b3 (31-33) 
('H.b3','TMP-rtxtryr','H(b3)','number',9,9.5,10,10.5,11,NULL,31,1,'','b3','table'),
('C.b3','TMP-rtxtryr','C(b3)','number',9,9.5,10,10.5,11,NULL,32,1,'','b3','table'),
('T.b3','TMP-rtxtryr','T(b3)','number',9,9.5,10,10.5,11,NULL,33,1,'','b3','table'),

-- b2 (34-36) 
('H.b2','TMP-rtxtryr','H(b2)','number',9,9.5,10,10.5,11,NULL,34,1,'','b2','table'),
('C.b2','TMP-rtxtryr','C(b2)','number',9,9.5,10,10.5,11,NULL,35,1,'','b2','table'),
('T.b2','TMP-rtxtryr','T(b2)','number',9,9.5,10,10.5,11,NULL,36,1,'','b2','table'),

-- b4 (37-39) 
('H.b4','TMP-rtxtryr','H(b4)','number',9,9.5,10,10.5,11,NULL,37,1,'','b4','table'),
('C.b4','TMP-rtxtryr','C(b4)','number',9,9.5,10,10.5,11,NULL,38,1,'','b4','table'),
('T.b4','TMP-rtxtryr','T(b4)','number',9,9.5,10,10.5,11,NULL,39,1,'','b4','table'),

-- b1-b2/2 (40-42) 
('H.b1-b2/2','TMP-rtxtryr','H(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,40,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-rtxtryr','C(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,41,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-rtxtryr','T(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,42,1,'','b1-b2/2','table'),

-- b3-b4/2 (43-45) 
('H.b3-b4/2','TMP-rtxtryr','H(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,43,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-rtxtryr','C(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,44,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-rtxtryr','T(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,45,1,'','b3-b4/2','table'),
