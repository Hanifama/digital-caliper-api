...
-- t2 (16-18)
('H.t2','TMP-rtxtuzh','H(t2)','number',33.3,34.15,35,35.85,36.7,NULL,16,1,'','t2','table'),
('C.t2','TMP-rtxtuzh','C(t2)','number',33.3,34.15,35,35.85,36.7,NULL,17,1,'','t2','table'),
('T.t2','TMP-rtxtuzh','T(t2)','number',33.3,34.15,35,35.85,36.7,NULL,18,1,'','t2','table'),

-- t3 (19-21)
('H.t3','TMP-rtxtuzh','H(t3)','number',33.3,34.15,35,35.85,36.7,NULL,19,1,'','t3','table'),
('C.t3','TMP-rtxtuzh','C(t3)','number',33.3,34.15,35,35.85,36.7,NULL,20,1,'','t3','table'),
('T.t3','TMP-rtxtuzh','T(t3)','number',33.3,34.15,35,35.85,36.7,NULL,21,1,'','t3','table'),
...
-- b1 (28-30)
('H.b1','TMP-rtxtuzh','H(b1)','number',33.3,34.15,35,35.85,36.7,NULL,28,1,'','b1','table'),
('C.b1','TMP-rtxtuzh','C(b1)','number',33.3,34.15,35,35.85,36.7,NULL,29,1,'','b1','table'),
('T.b1','TMP-rtxtuzh','T(b1)','number',33.3,34.15,35,35.85,36.7,NULL,30,1,'','b1','table'),

-- b3 (31-33)
('H.b3','TMP-rtxtuzh','H(b3)','number',33.3,34.15,35,35.85,36.7,NULL,31,1,'','b3','table'),
('C.b3','TMP-rtxtuzh','C(b3)','number',33.3,34.15,35,35.85,36.7,NULL,32,1,'','b3','table'),
('T.b3','TMP-rtxtuzh','T(b3)','number',33.3,34.15,35,35.85,36.7,NULL,33,1,'','b3','table'),

-- b2 (34-36)
('H.b2','TMP-rtxtuzh','H(b2)','number',33.3,34.15,35,35.85,36.7,NULL,34,1,'','b2','table'),
('C.b2','TMP-rtxtuzh','C(b2)','number',33.3,34.15,35,35.85,36.7,NULL,35,1,'','b2','table'),
('T.b2','TMP-rtxtuzh','T(b2)','number',33.3,34.15,35,35.85,36.7,NULL,36,1,'','b2','table'),

-- b4 (37-39)
('H.b4','TMP-rtxtuzh','H(b4)','number',33.3,34.15,35,35.85,36.7,NULL,37,1,'','b4','table'),
('C.b4','TMP-rtxtuzh','C(b4)','number',33.3,34.15,35,35.85,36.7,NULL,38,1,'','b4','table'),
('T.b4','TMP-rtxtuzh','T(b4)','number',33.3,34.15,35,35.85,36.7,NULL,39,1,'','b4','table'),

-- b1-b2/2 (40-42)
('H.b1-b2/2','TMP-rtxtuzh','H(b1-b2/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 40, 1, '', 'b1-b2/2', 'table'),
('C.b1-b2/2','TMP-rtxtuzh','C(b1-b2/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 41, 1, '', 'b1-b2/2', 'table'),
('T.b1-b2/2','TMP-rtxtuzh','T(b1-b2/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 42, 1, '', 'b1-b2/2', 'table'),

-- b3-b4/2 (43-45)
('H.b3-b4/2','TMP-rtxtuzh','H(b3-b4/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 43, 1, '', 'b3-b4/2', 'table'),
('C.b3-b4/2','TMP-rtxtuzh','C(b3-b4/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 44, 1, '', 'b3-b4/2', 'table'),
('T.b3-b4/2','TMP-rtxtuzh','T(b3-b4/2)','number',-3.5, -1.75, 0, 1.75, 3.5, NULL, 45, 1, '', 'b3-b4/2', 'table'),
