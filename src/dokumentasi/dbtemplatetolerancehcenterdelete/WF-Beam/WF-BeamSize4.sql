...
('H.b1','TMP-wfdhrsvc','H(b1)','number',7.5,8.25,9,9.75,10.5,NULL,13,1,'','b1','table'),
('C.b1','TMP-wfdhrsvc','C(b1)','number',7.5,8.25,9,9.75,10.5,NULL,14,1,'','b1','table'),
('T.b1','TMP-wfdhrsvc','T(b1)','number',7.5,8.25,9,9.75,10.5,NULL,15,1,'','b1','table'),

-- b3 (16-18) - Flange Thickness
('H.b3','TMP-wfdhrsvc','H(b3)','number',7.5,8.25,9,9.75,10.5,NULL,16,1,'','b3','table'),
('C.b3','TMP-wfdhrsvc','C(b3)','number',7.5,8.25,9,9.75,10.5,NULL,17,1,'','b3','table'),
('T.b3','TMP-wfdhrsvc','T(b3)','number',7.5,8.25,9,9.75,10.5,NULL,18,1,'','b3','table'),

-- b2 (19-21) - Flange Thickness
('H.b2','TMP-wfdhrsvc','H(b2)','number',7.5,8.25,9,9.75,10.5,NULL,19,1,'','b2','table'),
('C.b2','TMP-wfdhrsvc','C(b2)','number',7.5,8.25,9,9.75,10.5,NULL,20,1,'','b2','table'),
('T.b2','TMP-wfdhrsvc','T(b2)','number',7.5,8.25,9,9.75,10.5,NULL,21,1,'','b2','table'),

-- b4 (22-24) - Flange Thickness
('H.b4','TMP-wfdhrsvc','H(b4)','number',7.5,8.25,9,9.75,10.5,NULL,22,1,'','b4','table'),
('C.b4','TMP-wfdhrsvc','C(b4)','number',7.5,8.25,9,9.75,10.5,NULL,23,1,'','b4','table'),
('T.b4','TMP-wfdhrsvc','T(b4)','number',7.5,8.25,9,9.75,10.5,NULL,24,1,'','b4','table'),

-- b1-b2/2 (25-27) - Web Off Center
('H.b1-b2/2','TMP-wfdhrsvc','H(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,25,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-wfdhrsvc','C(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,26,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-wfdhrsvc','T(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,27,1,'','b1-b2/2','table'),

-- b3-b4/2 (28-30) - Web Off Center
('H.b3-b4/2','TMP-wfdhrsvc','H(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,28,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-wfdhrsvc','C(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,29,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-wfdhrsvc','T(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,30,1,'','b3-b4/2','table'),

-- t1 (31-33) - Flange Thickness
('H.t1','TMP-wfdhrsvc','H(t1)','number',7.5,8.25,9,9.75,10.5,NULL,31,1,'','t1','table'),
('C.t1','TMP-wfdhrsvc','C(t1)','number',7.5,8.25,9,9.75,10.5,NULL,32,1,'','t1','table'),
('T.t1','TMP-wfdhrsvc','T(t1)','number',7.5,8.25,9,9.75,10.5,NULL,33,1,'','t1','table'),

-- t3 (34-36) - Flange Thickness
('H.t3','TMP-wfdhrsvc','H(t3)','number',7.5,8.25,9,9.75,10.5,NULL,34,1,'','t3','table'),
('C.t3','TMP-wfdhrsvc','C(t3)','number',7.5,8.25,9,9.75,10.5,NULL,35,1,'','t3','table'),
('T.t3','TMP-wfdhrsvc','T(t3)','number',7.5,8.25,9,9.75,10.5,NULL,36,1,'','t3','table'),

-- t2 (37-39) - Flange Thickness
('H.t2','TMP-wfdhrsvc','H(t2)','number',7.5,8.25,9,9.75,10.5,NULL,37,1,'','t2','table'),
('C.t2','TMP-wfdhrsvc','C(t2)','number',7.5,8.25,9,9.75,10.5,NULL,38,1,'','t2','table'),
('T.t2','TMP-wfdhrsvc','T(t2)','number',7.5,8.25,9,9.75,10.5,NULL,39,1,'','t2','table'),

-- t4 (40-42) - Flange Thickness
('H.t4','TMP-wfdhrsvc','H(t4)','number',7.5,8.25,9,9.75,10.5,NULL,40,1,'','t4','table'),
('C.t4','TMP-wfdhrsvc','C(t4)','number',7.5,8.25,9,9.75,10.5,NULL,41,1,'','t4','table'),
('T.t4','TMP-wfdhrsvc','T(t4)','number',7.5,8.25,9,9.75,10.5,NULL,42,1,'','t4','table'),

-- t5 (43-45) - Web Thickness
('H.t5','TMP-wfdhrsvc','H(t5)','number',5,5.65,6.3,6.95,7.6,NULL,43,1,'','t5','table'),
('C.t5','TMP-wfdhrsvc','C(t5)','number',5,5.65,6.3,6.95,7.6,NULL,44,1,'','t5','table'),
('T.t5','TMP-wfdhrsvc','T(t5)','number',5,5.65,6.3,6.95,7.6,NULL,45,1,'','t5','table'),

-- t6 (NULL) - Web Thickness
('H.t6','TMP-wfdhrsvc','H(t6)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t6','table'),
('C.t6','TMP-wfdhrsvc','C(t6)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t6','table'),
('T.t6','TMP-wfdhrsvc','T(t6)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t6','table'),

-- t7 (NULL) - Web Thickness  
('H.t7','TMP-wfdhrsvc','H(t7)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t7','table'),
('C.t7','TMP-wfdhrsvc','C(t7)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t7','table'),
('T.t7','TMP-wfdhrsvc','T(t7)','number',5,5.65,6.3,6.95,7.6,NULL,NULL,1,'','t7','table'),
