...
('H.t3','TMP-wfimwyah','H(t3)','number',7.5,8.25,9,9.75,10.5,NULL,16,1,'','t3','table'),
('C.t3','TMP-wfimwyah','C(t3)','number',7.5,8.25,9,9.75,10.5,NULL,17,1,'','t3','table'),
('T.t3','TMP-wfimwyah','T(t3)','number',7.5,8.25,9,9.75,10.5,NULL,18,1,'','t3','table'),
...
('H.t6','TMP-wfimwyah','H(t6)','number',4,4.65,5.3,5.95,6.6,NULL,28,1,'','t6','table'),
('C.t6','TMP-wfimwyah','C(t6)','number',4,4.65,5.3,5.95,6.6,NULL,29,1,'','t6','table'),
('T.t6','TMP-wfimwyah','T(t6)','number',4,4.65,5.3,5.95,6.6,NULL,30,1,'','t6','table'),

-- t7 (31-33) - Web Thickness
('H.t7','TMP-wfimwyah','H(t7)','number',4,4.65,5.3,5.95,6.6,NULL,31,1,'','t7','table'),
('C.t7','TMP-wfimwyah','C(t7)','number',4,4.65,5.3,5.95,6.6,NULL,32,1,'','t7','table'),
('T.t7','TMP-wfimwyah','T(t7)','number',4,4.65,5.3,5.95,6.6,NULL,33,1,'','t7','table'),

-- b1 (34-36) - Flange Thickness
('H.b1','TMP-wfimwyah','H(b1)','number',7.5,8.25,9,9.75,10.5,NULL,34,1,'','b1','table'),
('C.b1','TMP-wfimwyah','C(b1)','number',7.5,8.25,9,9.75,10.5,NULL,35,1,'','b1','table'),
('T.b1','TMP-wfimwyah','T(b1)','number',7.5,8.25,9,9.75,10.5,NULL,36,1,'','b1','table'),

-- b3 (37-39) - Flange Thickness
('H.b3','TMP-wfimwyah','H(b3)','number',7.5,8.25,9,9.75,10.5,NULL,37,1,'','b3','table'),
('C.b3','TMP-wfimwyah','C(b3)','number',7.5,8.25,9,9.75,10.5,NULL,38,1,'','b3','table'),
('T.b3','TMP-wfimwyah','T(b3)','number',7.5,8.25,9,9.75,10.5,NULL,39,1,'','b3','table'),

-- b2 (40-42) - Flange Thickness
('H.b2','TMP-wfimwyah','H(b2)','number',7.5,8.25,9,9.75,10.5,NULL,40,1,'','b2','table'),
('C.b2','TMP-wfimwyah','C(b2)','number',7.5,8.25,9,9.75,10.5,NULL,41,1,'','b2','table'),
('T.b2','TMP-wfimwyah','T(b2)','number',7.5,8.25,9,9.75,10.5,NULL,42,1,'','b2','table'),

-- b4 (43-45) - Flange Thickness
('H.b4','TMP-wfimwyah','H(b4)','number',7.5,8.25,9,9.75,10.5,NULL,43,1,'','b4','table'),
('C.b4','TMP-wfimwyah','C(b4)','number',7.5,8.25,9,9.75,10.5,NULL,44,1,'','b4','table'),
('T.b4','TMP-wfimwyah','T(b4)','number',7.5,8.25,9,9.75,10.5,NULL,45,1,'','b4','table'),

-- b1-b2/2 (46-48) - Web Off Center
('H.b1-b2/2','TMP-wfimwyah','H(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,46,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-wfimwyah','C(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,47,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-wfimwyah','T(b1-b2/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,48,1,'','b1-b2/2','table'),

-- b3-b4/2 (49-51) - Web Off Center
('H.b3-b4/2','TMP-wfimwyah','H(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,49,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-wfimwyah','C(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,50,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-wfimwyah','T(b3-b4/2)','number',-2.5,-1.25,0,1.25,2.5,NULL,51,1,'','b3-b4/2','table'),

-- FormRight (52-60)
('height.of.flange','TMP-wfimwyah','Height of Flange','number',121.5,122.75,124,125.25,126.5,0,52,1,'','FormRight','Height of Flange'),
('flange.thickness','TMP-wfimwyah','Flange Thickness','number',7.5,8.25,9,9.75,10.5,0,53,1,'','FormRight','Flange Thickness'),
('width.of.web','TMP-wfimwyah','Width of Web','number',246,247,248,249,250,0,54,1,'','FormRight','Width of Web'),
('web.thickness','TMP-wfimwyah','Web Thickness','number',4,4.65,5.3,5.95,6.6,0,55,1,'','FormRight','Web Thickness'),
('unit.weight','TMP-wfimwyah','Unit Weight (Kgm)','number',25.5,26.3,27.1,27.9,28.7,0,56,1,'','FormRight','Unit Weight (Kgm)'),
('radius','TMP-wfimwyah','Radius','number',0,0,8,0,0,0,57,1,'','FormRight','Radius'),
('web.off.center','TMP-wfimwyah','Web Off Center','number',-2.5,-1.25,0,1.25,2.5,0,58,1,'','FormRight','Web Off Center'),
('os','TMP-wfimwyah','OS','number',0,0,1.5,0,0,0,59,1,'','FormRight','OS'),
('cow','TMP-wfimwyah','CoW','number',0,0,0,0,0,2,60,1,'','FormRight','CoW');
