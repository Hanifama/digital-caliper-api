...
('H.t2','TMP-wfnddbef','H(t2)','number',7.5,8.25,9,9.75,10.5,NULL,16,1,'','t2','table'),
('C.t2','TMP-wfnddbef','C(t2)','number',7.5,8.25,9,9.75,10.5,NULL,17,1,'','t2','table'),
('T.t2','TMP-wfnddbef','T(t2)','number',7.5,8.25,9,9.75,10.5,NULL,18,1,'','t2','table'),

-- t3 (19-21) - Flange Thickness
('H.t3','TMP-wfnddbef','H(t3)','number',7.5,8.25,9,9.75,10.5,NULL,19,1,'','t3','table'),
('C.t3','TMP-wfnddbef','C(t3)','number',7.5,8.25,9,9.75,10.5,NULL,20,1,'','t3','table'),
('T.t3','TMP-wfnddbef','T(t3)','number',7.5,8.25,9,9.75,10.5,NULL,21,1,'','t3','table'),
...
('H.b1','TMP-wfnddbef','H(b1)','number',7.5,8.25,9,9.75,10.5,NULL,28,1,'','b1','table'),
('C.b1','TMP-wfnddbef','C(b1)','number',7.5,8.25,9,9.75,10.5,NULL,29,1,'','b1','table'),
('T.b1','TMP-wfnddbef','T(b1)','number',7.5,8.25,9,9.75,10.5,NULL,30,1,'','b1','table'),

-- b3 (31-33) - Flange Thickness
('H.b3','TMP-wfnddbef','H(b3)','number',7.5,8.25,9,9.75,10.5,NULL,31,1,'','b3','table'),
('C.b3','TMP-wfnddbef','C(b3)','number',7.5,8.25,9,9.75,10.5,NULL,32,1,'','b3','table'),
('T.b3','TMP-wfnddbef','T(b3)','number',7.5,8.25,9,9.75,10.5,NULL,33,1,'','b3','table'),

-- b2 (34-36) - Flange Thickness
('H.b2','TMP-wfnddbef','H(b2)','number',7.5,8.25,9,9.75,10.5,NULL,34,1,'','b2','table'),
('C.b2','TMP-wfnddbef','C(b2)','number',7.5,8.25,9,9.75,10.5,NULL,35,1,'','b2','table'),
('T.b2','TMP-wfnddbef','T(b2)','number',7.5,8.25,9,9.75,10.5,NULL,36,1,'','b2','table'),

-- b4 (37-39) - Flange Thickness
('H.b4','TMP-wfnddbef','H(b4)','number',7.5,8.25,9,9.75,10.5,NULL,37,1,'','b4','table'),
('C.b4','TMP-wfnddbef','C(b4)','number',7.5,8.25,9,9.75,10.5,NULL,38,1,'','b4','table'),
('T.b4','TMP-wfnddbef','T(b4)','number',7.5,8.25,9,9.75,10.5,NULL,39,1,'','b4','table'),

-- b1-b2/2 (40-42) - Web Off Center
('H.b1-b2/2','TMP-wfnddbef','H(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,40,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-wfnddbef','C(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,41,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-wfnddbef','T(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,42,1,'','b1-b2/2','table'),

-- b3-b4/2 (43-45) - Web Off Center
('H.b3-b4/2','TMP-wfnddbef','H(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,43,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-wfnddbef','C(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,44,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-wfnddbef','T(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,45,1,'','b3-b4/2','table'),
