...
('H.b1','TMP-wfqggeti','H(b1)','number',10,10.5,11,11.5,12,NULL,13,1,'','b1','table'),
('C.b1','TMP-wfqggeti','C(b1)','number',10,10.5,11,11.5,12,NULL,14,1,'','b1','table'),
('T.b1','TMP-wfqggeti','T(b1)','number',10,10.5,11,11.5,12,NULL,15,1,'','b1','table'),

-- b3 (16-18) - Flange Thickness (Tebal Kaki)
('H.b3','TMP-wfqggeti','H(b3)','number',10,10.5,11,11.5,12,NULL,16,1,'','b3','table'),
('C.b3','TMP-wfqggeti','C(b3)','number',10,10.5,11,11.5,12,NULL,17,1,'','b3','table'),
('T.b3','TMP-wfqggeti','T(b3)','number',10,10.5,11,11.5,12,NULL,18,1,'','b3','table'),

-- b2 (19-21) - Flange Thickness (Tebal Kaki)
('H.b2','TMP-wfqggeti','H(b2)','number',10,10.5,11,11.5,12,NULL,19,1,'','b2','table'),
('C.b2','TMP-wfqggeti','C(b2)','number',10,10.5,11,11.5,12,NULL,20,1,'','b2','table'),
('T.b2','TMP-wfqggeti','T(b2)','number',10,10.5,11,11.5,12,NULL,21,1,'','b2','table'),

-- b4 (22-24) - Flange Thickness (Tebal Kaki)
('H.b4','TMP-wfqggeti','H(b4)','number',10,10.5,11,11.5,12,NULL,22,1,'','b4','table'),
('C.b4','TMP-wfqggeti','C(b4)','number',10,10.5,11,11.5,12,NULL,23,1,'','b4','table'),
('T.b4','TMP-wfqggeti','T(b4)','number',10,10.5,11,11.5,12,NULL,24,1,'','b4','table'),

-- b1-b2/2 (25-27) - Web Off Center (WOC) - diubah dari b1-b2/2
('H.b1-b2/2','TMP-wfqggeti','H(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,25,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-wfqggeti','C(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,26,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-wfqggeti','T(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,27,1,'','b1-b2/2','table'),

-- b3-b4/2 (28-30) - Web Off Center (WOC)
('H.b3-b4/2','TMP-wfqggeti','H(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,28,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-wfqggeti','C(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,29,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-wfqggeti','T(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,30,1,'','b3-b4/2','table'),

-- t1 (31-33) - Flange Thickness
('H.t1','TMP-wfqggeti','H(t1)','number',10,10.5,11,11.5,12,NULL,31,1,'','t1','table'),
('C.t1','TMP-wfqggeti','C(t1)','number',10,10.5,11,11.5,12,NULL,32,1,'','t1','table'),
('T.t1','TMP-wfqggeti','T(t1)','number',10,10.5,11,11.5,12,NULL,33,1,'','t1','table'),

-- t3 (34-36) - Flange Thickness
('H.t3','TMP-wfqggeti','H(t3)','number',10,10.5,11,11.5,12,NULL,34,1,'','t3','table'),
('C.t3','TMP-wfqggeti','C(t3)','number',10,10.5,11,11.5,12,NULL,35,1,'','t3','table'),
('T.t3','TMP-wfqggeti','T(t3)','number',10,10.5,11,11.5,12,NULL,36,1,'','t3','table'),

-- t2 (37-39) - Flange Thickness
('H.t2','TMP-wfqggeti','H(t2)','number',10,10.5,11,11.5,12,NULL,37,1,'','t2','table'),
('C.t2','TMP-wfqggeti','C(t2)','number',10,10.5,11,11.5,12,NULL,38,1,'','t2','table'),
('T.t2','TMP-wfqggeti','T(t2)','number',10,10.5,11,11.5,12,NULL,39,1,'','t2','table'),

-- t4 (40-42) - Flange Thickness
('H.t4','TMP-wfqggeti','H(t4)','number',10,10.5,11,11.5,12,NULL,40,1,'','t4','table'),
('C.t4','TMP-wfqggeti','C(t4)','number',10,10.5,11,11.5,12,NULL,41,1,'','t4','table'),
('T.t4','TMP-wfqggeti','T(t4)','number',10,10.5,11,11.5,12,NULL,42,1,'','t4','table'),

-- t5 (43-45) - Web Thickness (Tebal Web)
('H.t5','TMP-wfqggeti','H(t5)','number',6.3,6.65,7,7.35,7.7,NULL,43,1,'','t5','table'),
('C.t5','TMP-wfqggeti','C(t5)','number',6.3,6.65,7,7.35,7.7,NULL,44,1,'','t5','table'),
('T.t5','TMP-wfqggeti','T(t5)','number',6.3,6.65,7,7.35,7.7,NULL,45,1,'','t5','table'),

-- t6 (order number null) - Web Thickness (Tebal Web)
('H.t6','TMP-wfqggeti','H(t6)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t6','table'),
('C.t6','TMP-wfqggeti','C(t6)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t6','table'),
('T.t6','TMP-wfqggeti','T(t6)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t6','table'),

-- t7 (order number null) - Web Thickness (Tebal Web)
('H.t7','TMP-wfqggeti','H(t7)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t7','table'),
('C.t7','TMP-wfqggeti','C(t7)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t7','table'),
('T.t7','TMP-wfqggeti','T(t7)','number',6.3,6.65,7,7.35,7.7,NULL,NULL,1,'','t7','table'),
