...
('H.t3','TMP-wfqggeti','H(t3)','number',10,10.5,11,11.5,12,NULL,16,1,'','t3','table'),
('C.t3','TMP-wfqggeti','C(t3)','number',10,10.5,11,11.5,12,NULL,17,1,'','t3','table'),
('T.t3','TMP-wfqggeti','T(t3)','number',10,10.5,11,11.5,12,NULL,18,1,'','t3','table'),
...
('H.t6','TMP-wfqggeti','H(t6)','number',6.3,6.65,7,7.35,7.7,NULL,28,1,'','t6','table'),
('C.t6','TMP-wfqggeti','C(t6)','number',6.3,6.65,7,7.35,7.7,NULL,29,1,'','t6','table'),
('T.t6','TMP-wfqggeti','T(t6)','number',6.3,6.65,7,7.35,7.7,NULL,30,1,'','t6','table'),

-- t7 (31-33) - Web Thickness (Tebal Web)
('H.t7','TMP-wfqggeti','H(t7)','number',6.3,6.65,7,7.35,7.7,NULL,31,1,'','t7','table'),
('C.t7','TMP-wfqggeti','C(t7)','number',6.3,6.65,7,7.35,7.7,NULL,32,1,'','t7','table'),
('T.t7','TMP-wfqggeti','T(t7)','number',6.3,6.65,7,7.35,7.7,NULL,33,1,'','t7','table'),

-- b1 (34-36) - Flange Thickness (Tebal Kaki)
('H.b1','TMP-wfqggeti','H(b1)','number',10,10.5,11,11.5,12,NULL,34,1,'','b1','table'),
('C.b1','TMP-wfqggeti','C(b1)','number',10,10.5,11,11.5,12,NULL,35,1,'','b1','table'),
('T.b1','TMP-wfqggeti','T(b1)','number',10,10.5,11,11.5,12,NULL,36,1,'','b1','table'),

-- b3 (37-39) - Flange Thickness (Tebal Kaki)
('H.b3','TMP-wfqggeti','H(b3)','number',10,10.5,11,11.5,12,NULL,37,1,'','b3','table'),
('C.b3','TMP-wfqggeti','C(b3)','number',10,10.5,11,11.5,12,NULL,38,1,'','b3','table'),
('T.b3','TMP-wfqggeti','T(b3)','number',10,10.5,11,11.5,12,NULL,39,1,'','b3','table'),

-- b2 (40-42) - Flange Thickness (Tebal Kaki)
('H.b2','TMP-wfqggeti','H(b2)','number',10,10.5,11,11.5,12,NULL,40,1,'','b2','table'),
('C.b2','TMP-wfqggeti','C(b2)','number',10,10.5,11,11.5,12,NULL,41,1,'','b2','table'),
('T.b2','TMP-wfqggeti','T(b2)','number',10,10.5,11,11.5,12,NULL,42,1,'','b2','table'),

-- b4 (43-45) - Flange Thickness (Tebal Kaki)
('H.b4','TMP-wfqggeti','H(b4)','number',10,10.5,11,11.5,12,NULL,43,1,'','b4','table'),
('C.b4','TMP-wfqggeti','C(b4)','number',10,10.5,11,11.5,12,NULL,44,1,'','b4','table'),
('T.b4','TMP-wfqggeti','T(b4)','number',10,10.5,11,11.5,12,NULL,45,1,'','b4','table'),

-- b1-b2/2 (46-48) - Web Off Center (WOC)
('H.b1-b2/2','TMP-wfqggeti','H(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,46,1,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-wfqggeti','C(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,47,1,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-wfqggeti','T(b1-b2/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,48,1,'','b1-b2/2','table'),

-- b3-b4/2 (49-51) - Web Off Center (WOC)
('H.b3-b4/2','TMP-wfqggeti','H(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,49,1,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-wfqggeti','C(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,50,1,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-wfqggeti','T(b3-b4/2)','number',-3.5,-1.75,0,1.75,3.5,NULL,51,1,'','b3-b4/2','table'),

-- FormRight (52-60)
('height.of.flange','TMP-wfqggeti','Height of Flange','number',196.5,197.75,199,200.25,201.5,0,52,1,'','FormRight','Height of Flange'),
('flange.thickness','TMP-wfqggeti','Flange Thickness','number',10,10.5,11,11.5,12,0,53,1,'','FormRight','Flange Thickness'),
('width.of.web','TMP-wfqggeti','Width of Web','number',394,395,396,397,398,0,54,1,'','FormRight','Width of Web'),
('web.thickness','TMP-wfqggeti','Web Thickness','number',6.3,6.65,7,7.35,7.7,0,55,1,'','FormRight','Web Thickness'),
('unit.weight','TMP-wfqggeti','Unit Weight (Kgm)','number',53.9,55.0,56.1,57.2,58.3,0,56,1,'','FormRight','Unit Weight (Kgm)'),
('radius','TMP-wfqggeti','Radius','number',0,0,13,0,0,0,57,1,'','FormRight','Radius'),
('web.off.center','TMP-wfqggeti','Web Off Center','number',-3.5,-1.75,0,1.75,3.5,0,58,1,'','FormRight','Web Off Center'),
('os','TMP-wfqggeti','OS','number',0,0,2.39,0,0,0,59,1,'','FormRight','OS'),
('cow','TMP-wfqggeti','CoW','number',0,0,0,0,0,2,60,1,'','FormRight','CoW');
