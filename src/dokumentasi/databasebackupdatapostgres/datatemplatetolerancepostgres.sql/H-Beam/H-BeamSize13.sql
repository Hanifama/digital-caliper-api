...
-- b1 (13-15)
('H.b1','TMP-rtxfdzb','H(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-rtxfdzb','C(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-rtxfdzb','T(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,15,true,'','b1','table'),

-- b3 (16-18)
('H.b3','TMP-rtxfdzb','H(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-rtxfdzb','C(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-rtxfdzb','T(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,18,true,'','b3','table'),

-- b2 (19-21)
('H.b2','TMP-rtxfdzb','H(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-rtxfdzb','C(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-rtxfdzb','T(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,21,true,'','b2','table'),

-- b4 (22-24)
('H.b4','TMP-rtxfdzb','H(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-rtxfdzb','C(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-rtxfdzb','T(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,24,true,'','b4','table'),
...
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Width of Web', 'H-Bottom', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Flange Thickness', 't4', 2),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b1', 3),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Flange Thickness', 't1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b2', 4),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b3', 5),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Width of Web', 'H-Top', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b4', 6),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Flange Thickness', 't2', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Height of Flange', 'B2', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'OS', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Flange Thickness', 't3', 2),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Radius', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Unit Weight (Kgm)', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Height of Flange', 'B1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'CoW', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Thickness', 't5', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b1-b2/2', 7),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Off Center', 'b3-b4/2', 8),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Thickness', 't6', 9),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxfdzb', 'Web Thickness', 't7', 10);