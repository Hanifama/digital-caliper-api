...
-- b1 (13-15)
('H.b1','TMP-rtxtuyt','H(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-rtxtuyt','C(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-rtxtuyt','T(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,15,true,'','b1','table'),

-- b3 (16-18)
('H.b3','TMP-rtxtuyt','H(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-rtxtuyt','C(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-rtxtuyt','T(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,18,true,'','b3','table'),

-- b2 (19-21)
('H.b2','TMP-rtxtuyt','H(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-rtxtuyt','C(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-rtxtuyt','T(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,21,true,'','b2','table'),

-- b4 (22-24)
('H.b4','TMP-rtxtuyt','H(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-rtxtuyt','C(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-rtxtuyt','T(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,24,true,'','b4','table'),
...
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Width of Web', 'H-Bottom', 1),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 't4', 2),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b1', 3),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 't1', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b2', 4),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b3', 5),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Width of Web', 'H-Top', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b4', 6),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 't2', 1),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Height of Flange', 'B2', 1),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'OS', '', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 't3', 2),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Radius', '', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Unit Weight (Kgm)', '', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Height of Flange', 'B1', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'CoW', '', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Thickness', 't5', 0),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b3-b4/2', 8),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Off Center', 'b1-b2/2', 7),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Thickness', 't6', 9),
(CONCAT('MAP', LEFT(uuid_generate_v4()::text, 8)), 'TMP-rtxtuyt', 'Web Thickness', 't7', 10);