...
('H.b1','TMP-rtxtuzh','H(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-rtxtuzh','C(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-rtxtuzh','T(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,15,true,'','b1','table'),

-- b3 (16-18) - tolerance sama dengan Web Off Center
('H.b3','TMP-rtxtuzh','H(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-rtxtuzh','C(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-rtxtuzh','T(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,18,true,'','b3','table'),

-- b2 (19-21) - tolerance sama dengan Web Off Center
('H.b2','TMP-rtxtuzh','H(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-rtxtuzh','C(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-rtxtuzh','T(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,21,true,'','b2','table'),

-- b4 (22-24) - tolerance sama dengan Web Off Center
('H.b4','TMP-rtxtuzh','H(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-rtxtuzh','C(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-rtxtuzh','T(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,24,true,'','b4','table'),
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Flange Thickness', 't4', 3),
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Width of Web', 'H-Bottom', 1),
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b1', 4),  -- b1 mapping ke Web Off Center
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b2', 5),  -- b2 mapping ke Web Off Center
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b3', 6),  -- b3 mapping ke Web Off Center
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b4', 7),  -- b4 mapping ke Web Off Center
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b1-b2/2', 8),
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Web Off Center', 'b3-b4/2', 9);