...
-- b1 (13-15) 
('H.b1','TMP-rtxtuyp','H(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-rtxtuyp','C(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-rtxtuyp','T(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,15,true,'','b1','table'),

-- b3 (16-18) 
('H.b3','TMP-rtxtuyp','H(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-rtxtuyp','C(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-rtxtuyp','T(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,18,true,'','b3','table'),

-- b2 (19-21) 
('H.b2','TMP-rtxtuyp','H(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-rtxtuyp','C(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-rtxtuyp','T(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,21,true,'','b2','table'),

-- b4 (22-24) 
('H.b4','TMP-rtxtuyp','H(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-rtxtuyp','C(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-rtxtuyp','T(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,24,true,'','b4','table'),
...
('MAP8132414H9', 'TMP-rtxtuyp', 'Web Off Center', 'b1', 3),
('MAP8132415DP', 'TMP-rtxtuyp', 'Flange Thickness', 't1', 0),
('MAP8132418TC', 'TMP-rtxtuyp', 'Web Off Center', 'b2', 4),
('MAP813241A0O', 'TMP-rtxtuyp', 'Web Off Center', 'b3', 5),
('MAP813241ABM', 'TMP-rtxtuyp', 'Width of Web', 'H-Top', 0),
('MAP813241B75', 'TMP-rtxtuyp', 'Web Off Center', 'b4', 6),
...
('MAP813241JRA', 'TMP-rtxtuyp', 'Unit Weight (Kgm)', '', 0),
...
('MAP813241T6C', 'TMP-rtxtuyp', 'Web Thickness', 't6', 9),
('MAP813241T7C', 'TMP-rtxtuyp', 'Web Thickness', 't7', 10);