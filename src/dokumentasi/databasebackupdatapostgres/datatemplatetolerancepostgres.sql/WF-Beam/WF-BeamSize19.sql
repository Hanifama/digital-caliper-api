...
-- b1 (13-15) - Flange Thickness (Tebal Kaki) - dengan nilai tolerance sama dengan FormRight Web Off Center
('H.b1','TMP-wfsiifvk','H(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,13,true,NULL,'b1','table'),
('C.b1','TMP-wfsiifvk','C(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,14,true,NULL,'b1','table'),
('T.b1','TMP-wfsiifvk','T(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,15,true,NULL,'b1','table'),

-- b3 (16-18) - Flange Thickness (Tebal Kaki) - dengan nilai tolerance sama dengan FormRight Web Off Center
('H.b3','TMP-wfsiifvk','H(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,16,true,NULL,'b3','table'),
('C.b3','TMP-wfsiifvk','C(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,17,true,NULL,'b3','table'),
('T.b3','TMP-wfsiifvk','T(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,18,true,NULL,'b3','table'),

-- b2 (19-21) - Flange Thickness (Tebal Kaki) - dengan nilai tolerance sama dengan FormRight Web Off Center
('H.b2','TMP-wfsiifvk','H(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,19,true,NULL,'b2','table'),
('C.b2','TMP-wfsiifvk','C(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,20,true,NULL,'b2','table'),
('T.b2','TMP-wfsiifvk','T(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,21,true,NULL,'b2','table'),

-- b4 (22-24) - Flange Thickness (Tebal Kaki) - dengan nilai tolerance sama dengan FormRight Web Off Center
('H.b4','TMP-wfsiifvk','H(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,22,true,NULL,'b4','table'),
('C.b4','TMP-wfsiifvk','C(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,23,true,NULL,'b4','table'),
('T.b4','TMP-wfsiifvk','T(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,24,true,NULL,'b4','table'),
...
-- t6 (NULL) - Web Thickness (Tebal Web) - order_numb NULL
...
-- t7 (NULL) - Web Thickness (Tebal Web) - order_numb NULL
...
('MAP' || LEFT(gen_random_uuid()::text, 8),  'TMP-wfsiifvk', 'Web Off Center', 'b1', 5),
('MAP' || LEFT(gen_random_uuid()::text, 8),  'TMP-wfsiifvk', 'Web Off Center', 'b3', 6),
('MAP' || LEFT(gen_random_uuid()::text, 8),  'TMP-wfsiifvk', 'Web Off Center', 'b2', 7),
('MAP' || LEFT(gen_random_uuid()::text, 8),  'TMP-wfsiifvk', 'Web Off Center', 'b4', 8),
