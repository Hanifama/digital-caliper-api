...
('H.b1','TMP-wfvllibm','H(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-wfvllibm','C(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-wfvllibm','T(b1)','number',-3.5,-1.75,0,1.75,3.5,NULL,15,true,'','b1','table'),

-- b3 (16-18) - Web Off Center
('H.b3','TMP-wfvllibm','H(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-wfvllibm','C(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-wfvllibm','T(b3)','number',-3.5,-1.75,0,1.75,3.5,NULL,18,true,'','b3','table'),

-- b2 (19-21) - Web Off Center
('H.b2','TMP-wfvllibm','H(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-wfvllibm','C(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-wfvllibm','T(b2)','number',-3.5,-1.75,0,1.75,3.5,NULL,21,true,'','b2','table'),

-- b4 (22-24) - Web Off Center
('H.b4','TMP-wfvllibm','H(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-wfvllibm','C(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-wfvllibm','T(b4)','number',-3.5,-1.75,0,1.75,3.5,NULL,24,true,'','b4','table'),
...
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Width of Web', 'H-Top', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Width of Web', 'H-Bottom', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Height of Flange', 'B1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Height of Flange', 'B2', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Flange Thickness', 't1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Flange Thickness', 't2', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Flange Thickness', 't3', 2),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Flange Thickness', 't4', 3),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Thickness', 't5', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Thickness', 't6', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Thickness', 't7', 2),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b2', 1),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b3', 2),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b4', 3),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b1-b2/2', 4),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Web Off Center', 'b3-b4/2', 5),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Radius', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'CoW', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'OS', '', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfvllibm', 'Unit Weight (Kgm)', '', 0);