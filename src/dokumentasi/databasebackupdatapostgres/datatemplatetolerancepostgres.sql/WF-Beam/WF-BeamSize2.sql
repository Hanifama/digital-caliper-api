...
-- b1 (13-15) - Web Off Center (sesuai pola WF beam)
('H.b1','TMP-wfbgpzta','H(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,13,true,'','b1','table'),
('C.b1','TMP-wfbgpzta','C(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,14,true,'','b1','table'),
('T.b1','TMP-wfbgpzta','T(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,15,true,'','b1','table'),

-- b3 (16-18) - Web Off Center (sesuai pola WF beam)
('H.b3','TMP-wfbgpzta','H(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,16,true,'','b3','table'),
('C.b3','TMP-wfbgpzta','C(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,17,true,'','b3','table'),
('T.b3','TMP-wfbgpzta','T(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,18,true,'','b3','table'),

-- b2 (19-21) - Web Off Center (sesuai pola WF beam)
('H.b2','TMP-wfbgpzta','H(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,19,true,'','b2','table'),
('C.b2','TMP-wfbgpzta','C(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,20,true,'','b2','table'),
('T.b2','TMP-wfbgpzta','T(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,21,true,'','b2','table'),

-- b4 (22-24) - Web Off Center (sesuai pola WF beam)
('H.b4','TMP-wfbgpzta','H(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,22,true,'','b4','table'),
('C.b4','TMP-wfbgpzta','C(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,23,true,'','b4','table'),
('T.b4','TMP-wfbgpzta','T(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,24,true,'','b4','table'),
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 't4', 3),
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b1', 4),  -- b1 mapping ke Web Off Center (sesuai pola)
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b2', 5),  -- b2 mapping ke Web Off Center (sesuai pola)
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b3', 6),  -- b3 mapping ke Web Off Center (sesuai pola)
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b4', 7),  -- b4 mapping ke Web Off Center (sesuai pola)
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b1-b2/2', 8),
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b3-b4/2', 9),
