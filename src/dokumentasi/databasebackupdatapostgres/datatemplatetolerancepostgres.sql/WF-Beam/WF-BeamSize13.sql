...
-- b1 (13-15) - Web Off Center (toleransi serupa dengan FormRight Web Off Center: -2.5, -1.25, 0, 1.25, 2.5)
('H.b1','TMP-wfmpcade','H(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,13,true,NULL,'b1','table'),
('C.b1','TMP-wfmpcade','C(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,14,true,NULL,'b1','table'),
('T.b1','TMP-wfmpcade','T(b1)','number',-2.5,-1.25,0,1.25,2.5,NULL,15,true,NULL,'b1','table'),

-- b3 (16-18) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b3','TMP-wfmpcade','H(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,16,true,NULL,'b3','table'),
('C.b3','TMP-wfmpcade','C(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,17,true,NULL,'b3','table'),
('T.b3','TMP-wfmpcade','T(b3)','number',-2.5,-1.25,0,1.25,2.5,NULL,18,true,NULL,'b3','table'),

-- b2 (19-21) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b2','TMP-wfmpcade','H(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,19,true,NULL,'b2','table'),
('C.b2','TMP-wfmpcade','C(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,20,true,NULL,'b2','table'),
('T.b2','TMP-wfmpcade','T(b2)','number',-2.5,-1.25,0,1.25,2.5,NULL,21,true,NULL,'b2','table'),

-- b4 (22-24) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b4','TMP-wfmpcade','H(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,22,true,NULL,'b4','table'),
('C.b4','TMP-wfmpcade','C(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,23,true,NULL,'b4','table'),
('T.b4','TMP-wfmpcade','T(b4)','number',-2.5,-1.25,0,1.25,2.5,NULL,24,true,NULL,'b4','table'),
...
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b1', 0),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b2', 1),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b3', 2),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b4', 3),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b1-b2/2', 4),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b3-b4/2', 5),
