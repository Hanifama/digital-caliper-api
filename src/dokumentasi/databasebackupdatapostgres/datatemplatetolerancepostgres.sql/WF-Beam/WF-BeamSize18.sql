...
('H.b1', 'TMP-wfrhheuj', 'H(b1)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 13, true, '', 'b1', 'table'),
('C.b1', 'TMP-wfrhheuj', 'C(b1)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 14, true, '', 'b1', 'table'),
('T.b1', 'TMP-wfrhheuj', 'T(b1)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 15, true, '', 'b1', 'table'),

-- b3 (16-18) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b3', 'TMP-wfrhheuj', 'H(b3)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 16, true, '', 'b3', 'table'),
('C.b3', 'TMP-wfrhheuj', 'C(b3)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 17, true, '', 'b3', 'table'),
('T.b3', 'TMP-wfrhheuj', 'T(b3)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 18, true, '', 'b3', 'table'),

-- b2 (19-21) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b2', 'TMP-wfrhheuj', 'H(b2)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 19, true, '', 'b2', 'table'),
('C.b2', 'TMP-wfrhheuj', 'C(b2)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 20, true, '', 'b2', 'table'),
('T.b2', 'TMP-wfrhheuj', 'T(b2)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 21, true, '', 'b2', 'table'),

-- b4 (22-24) - Web Off Center (toleransi serupa dengan FormRight Web Off Center)
('H.b4', 'TMP-wfrhheuj', 'H(b4)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 22, true, '', 'b4', 'table'),
('C.b4', 'TMP-wfrhheuj', 'C(b4)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 23, true, '', 'b4', 'table'),
('T.b4', 'TMP-wfrhheuj', 'T(b4)', 'number', -3.5, -1.75, 0, 1.75, 3.5, NULL, 24, true, '', 'b4', 'table'),
...
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b1', 0),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b2', 1),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b3', 2),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b4', 3),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b1-b2/2', 4),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfrhheuj', 'Web Off Center', 'b3-b4/2', 5),
