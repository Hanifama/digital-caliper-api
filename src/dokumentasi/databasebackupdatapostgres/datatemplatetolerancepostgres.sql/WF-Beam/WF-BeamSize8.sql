...
('H.b1', 'TMP-wfhlvxzg', 'H(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 13, true, '', 'b1', 'table'),
('C.b1', 'TMP-wfhlvxzg', 'C(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 14, true, '', 'b1', 'table'),
('T.b1', 'TMP-wfhlvxzg', 'T(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 15, true, '', 'b1', 'table'),

-- b3 (16-18) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b3', 'TMP-wfhlvxzg', 'H(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 16, true, '', 'b3', 'table'),
('C.b3', 'TMP-wfhlvxzg', 'C(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 17, true, '', 'b3', 'table'),
('T.b3', 'TMP-wfhlvxzg', 'T(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 18, true, '', 'b3', 'table'),

-- b2 (19-21) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b2', 'TMP-wfhlvxzg', 'H(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 19, true, '', 'b2', 'table'),
('C.b2', 'TMP-wfhlvxzg', 'C(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 20, true, '', 'b2', 'table'),
('T.b2', 'TMP-wfhlvxzg', 'T(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 21, true, '', 'b2', 'table'),

-- b4 (22-24) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b4', 'TMP-wfhlvxzg', 'H(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 22, true, '', 'b4', 'table'),
('C.b4', 'TMP-wfhlvxzg', 'C(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 23, true, '', 'b4', 'table'),
('T.b4', 'TMP-wfhlvxzg', 'T(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 24, true, '', 'b4', 'table'),
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 't4', 3),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Thickness', 't6', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Thickness', 't7', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b1', 3),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b2', 4),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b3', 5),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b4', 6),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b1-b2/2', 7),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b3-b4/2', 8),
