...
('H.b1', 'TMP-wfcgqrub', 'H(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 13, true, '', 'b1', 'table'),
('C.b1', 'TMP-wfcgqrub', 'C(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 14, true, '', 'b1', 'table'),
('T.b1', 'TMP-wfcgqrub', 'T(b1)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 15, true, '', 'b1', 'table'),

-- b3 (16-18) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b3', 'TMP-wfcgqrub', 'H(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 16, true, '', 'b3', 'table'),
('C.b3', 'TMP-wfcgqrub', 'C(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 17, true, '', 'b3', 'table'),
('T.b3', 'TMP-wfcgqrub', 'T(b3)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 18, true, '', 'b3', 'table'),

-- b2 (19-21) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b2', 'TMP-wfcgqrub', 'H(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 19, true, '', 'b2', 'table'),
('C.b2', 'TMP-wfcgqrub', 'C(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 20, true, '', 'b2', 'table'),
('T.b2', 'TMP-wfcgqrub', 'T(b2)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 21, true, '', 'b2', 'table'),

-- b4 (22-24) - Web Off Center (dengan tolerance serupa FormRight Web Off Center)
('H.b4', 'TMP-wfcgqrub', 'H(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 22, true, '', 'b4', 'table'),
('C.b4', 'TMP-wfcgqrub', 'C(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 23, true, '', 'b4', 'table'),
('T.b4', 'TMP-wfcgqrub', 'T(b4)', 'number', -2.5, -1.25, 0, 1.25, 2.5, NULL, 24, true, '', 'b4', 'table'),
...
('C.t6', 'TMP-wfcgqrub', 'C(t6)', 'number', 4, 4.65, 5.3, 5.95, 6.6, NULL, NULL, true, '', 't6', 'table'),
('T.t6', 'TMP-wfcgqrub', 'T(t6)', 'number', 4, 4.65, 5.3, 5.95, 6.6, NULL, NULL, true, '', 't6', 'table'),
...
-- FormRight (46-54)
('height.of.flange', 'TMP-wfcgqrub', 'Height of Flange', 'number', 73, 74, 75, 76, 77, 0, 46, true, '', 'FormRight', 'Height of Flange'),
('flange.thickness', 'TMP-wfcgqrub', 'Flange Thickness', 'number', 5.5, 6.25, 7, 7.75, 8.5, 0, 47, true, '', 'FormRight', 'Flange Thickness'),
('width.of.web', 'TMP-wfcgqrub', 'Width of Web', 'number', 148, 149, 150, 151, 152, 0, 48, true, '', 'FormRight', 'Width of Web'),
('web.thickness', 'TMP-wfcgqrub', 'Web Thickness', 'number', 4, 4.65, 5.3, 5.95, 6.6, 0, 49, true, '', 'FormRight', 'Web Thickness'),
('unit.weight', 'TMP-wfcgqrub', 'Unit Weight (Kgm)', 'number', 13.1, 13.55, 14, 14.45, 14.9, 0, 50, true, '', 'FormRight', 'Unit Weight (Kgm)'),
('radius', 'TMP-wfcgqrub', 'Radius', 'number', 0, 0, 8, 0, 0, 0, 51, true, '', 'FormRight', 'Radius'),
('web.off.center', 'TMP-wfcgqrub', 'Web Off Center', 'number', -2.5, -1.25, 0, 1.25, 2.5, 0, 52, true, '', 'FormRight', 'Web Off Center'),
('os', 'TMP-wfcgqrub', 'OS', 'number', 0, 0, 1.5, 0, 0, 0, 53, true, '', 'FormRight', 'OS'),
('cow', 'TMP-wfcgqrub', 'CoW', 'number', 0, 0, 0, 0, 0, 2, 54, true, '', 'FormRight', 'CoW');

INSERT INTO qc_template_mapping (mapping_id, qc_template_id, group_name, position, order_numb) VALUES
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Width of Web', 'H-Top', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Width of Web', 'H-Bottom', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Height of Flange', 'B1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Height of Flange', 'B2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Flange Thickness', 't1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Flange Thickness', 't2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Flange Thickness', 't3', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Flange Thickness', 't4', 3),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Thickness', 't6', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Thickness', 't7', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b1', 3),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b2', 4),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b3', 5),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b4', 6),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b1-b2/2', 7),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Web Off Center', 'b3-b4/2', 8),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Radius', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'CoW', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'OS', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfcgqrub', 'Unit Weight (Kgm)', '', 0);