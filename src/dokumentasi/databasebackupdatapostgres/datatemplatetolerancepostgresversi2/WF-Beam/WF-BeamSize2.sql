...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 't4', 7), -- diubah dari 3 ke 7
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b1-b2/2', 0), -- order_numb disesuaikan
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-wfbgpzta', 'Web Off Center', 'b3-b4/2', 1), -- order_numb disesuaikan
