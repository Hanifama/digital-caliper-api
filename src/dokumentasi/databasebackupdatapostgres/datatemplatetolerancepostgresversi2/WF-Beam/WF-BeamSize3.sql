...
-- FormRight (52-60)
('height.of.flange', 'TMP-wfcgqrub', 'Height of Flange', 'number', 73, 74, 75, 76, 77, 0, 52, true, '', 'FormRight', 'Height of Flange'),
('flange.thickness', 'TMP-wfcgqrub', 'Flange Thickness', 'number', 5.5, 6.25, 7, 7.75, 8.5, 0, 53, true, '', 'FormRight', 'Flange Thickness'),
('width.of.web', 'TMP-wfcgqrub', 'Width of Web', 'number', 148, 149, 150, 151, 152, 0, 54, true, '', 'FormRight', 'Width of Web'),
('web.thickness', 'TMP-wfcgqrub', 'Web Thickness', 'number', 4, 4.65, 5.3, 5.95, 6.6, 0, 55, true, '', 'FormRight', 'Web Thickness'),
('unit.weight', 'TMP-wfcgqrub', 'Unit Weight (Kgm)', 'number', 13.1, 13.55, 14, 14.45, 14.9, 0, 56, true, '', 'FormRight', 'Unit Weight (Kgm)'),
('radius', 'TMP-wfcgqrub', 'Radius', 'number', 0, 0, 8, 0, 0, 0, 57, true, '', 'FormRight', 'Radius'),
('web.off.center', 'TMP-wfcgqrub', 'Web Off Center', 'number', -2.5, -1.25, 0, 1.25, 2.5, 0, 58, true, '', 'FormRight', 'Web Off Center'),
('os', 'TMP-wfcgqrub', 'OS', 'number', 0, 0, 1.5, 0, 0, 0, 59, true, '', 'FormRight', 'OS'),
('cow', 'TMP-wfcgqrub', 'CoW', 'number', 0, 0, 0, 0, 0, 2, 60, true, '', 'FormRight', 'CoW');

INSERT INTO qc_template_mapping (mapping_id, qc_template_id, group_name, position, order_numb) VALUES
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Width of Web', 'H-Bottom', 1),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Height of Flange', 'B1', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Height of Flange', 'B2', 1),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Flange Thickness', 't2', 1),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Flange Thickness', 't3', 2),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Flange Thickness', 't4', 3),
...
('MAP' || LEFT(md5(random()::text), 8), 'TMP-wfcgqrub', 'Unit Weight (Kgm)', '', 0);