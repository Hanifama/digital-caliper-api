...
-- FormRight (46-54)
('height.of.flange', 'TMP-wfukkhal', 'Height of Flange', 'number', 197, 198.5, 200, 201.5, 203, 0, 46, true, NULL, 'FormRight', 'Height of Flange'),
('flange.thickness', 'TMP-wfukkhal', 'Flange Thickness', 'number', 15.5, 16.25, 17, 17.75, 18.5, 0, 47, true, NULL, 'FormRight', 'Flange Thickness'),
('width.of.web', 'TMP-wfukkhal', 'Width of Web', 'number', 596, 598, 600, 602, 604, 0, 48, true, NULL, 'FormRight', 'Width of Web'),
('web.thickness', 'TMP-wfukkhal', 'Web Thickness', 'number', 10.3, 10.65, 11, 11.35, 11.7, 0, 49, true, NULL, 'FormRight', 'Web Thickness'),
('unit.weight', 'TMP-wfukkhal', 'Unit Weight (Kgm)', 'number', 98.9, 100.95, 103, 105.05, 107.1, 0, 50, true, NULL, 'FormRight', 'Unit Weight (Kgm)'),
('radius', 'TMP-wfukkhal', 'Radius', 'number', 0, 0, 13, 0, 0, 0, 51, true, NULL, 'FormRight', 'Radius'),
('web.off.center', 'TMP-wfukkhal', 'Web Off Center', 'number', -3.5, -1.75, 0, 1.75, 3.5, 0, 52, true, NULL, 'FormRight', 'Web Off Center'),
('os', 'TMP-wfukkhal', 'OS', 'number', 0, 0, 2.4, 0, 0, 0, 53, true, NULL, 'FormRight', 'OS'),
('cow', 'TMP-wfukkhal', 'CoW', 'number', 0, 0, 0, 0, 0, 3, 54, true, NULL, 'FormRight', 'CoW');

INSERT INTO qc_template_mapping (mapping_id, qc_template_id, group_name, position, order_numb) VALUES
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Width of Web', 'H-Top', 1),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Width of Web', 'H-Bottom', 2),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Height of Flange', 'B1', 3),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Height of Flange', 'B2', 4),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 'b1', 5),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 'b3', 6),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 'b2', 7),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 'b4', 8),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Web Off Center', 'b1-b2/2', 9),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Web Off Center', 'b3-b4/2', 10),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 't1', 11),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 't3', 12),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 't2', 13),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Flange Thickness', 't4', 14),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Web Thickness', 't5', 15),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Web Thickness', 't6', 16),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Web Thickness', 't7', 17),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Radius', '', 18),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'CoW', '', 19),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'OS', '', 20),
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfukkhal', 'Unit Weight (Kgm)', '', 21);