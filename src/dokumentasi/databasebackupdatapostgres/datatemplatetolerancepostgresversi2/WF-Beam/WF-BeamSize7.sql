...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b1', 4), 
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b2', 5),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b3', 6),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b4', 7),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Web Off Center', 'b1-b2/2', 8),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Web Off Center', 'b3-b4/2', 9), 
