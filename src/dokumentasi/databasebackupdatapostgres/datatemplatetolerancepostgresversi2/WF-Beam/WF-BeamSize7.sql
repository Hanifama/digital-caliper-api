...
('H.b1', 'TMP-wfgkuwyf', 'H(b1)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 13, true, '', 'b1', 'table'),
('C.b1', 'TMP-wfgkuwyf', 'C(b1)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 14, true, '', 'b1', 'table'),
('T.b1', 'TMP-wfgkuwyf', 'T(b1)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 15, true, '', 'b1', 'table'),

-- b3 (16-18) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (7.5,8.25,9,9.75,10.5)
('H.b3', 'TMP-wfgkuwyf', 'H(b3)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 16, true, '', 'b3', 'table'),
('C.b3', 'TMP-wfgkuwyf', 'C(b3)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 17, true, '', 'b3', 'table'),
('T.b3', 'TMP-wfgkuwyf', 'T(b3)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 18, true, '', 'b3', 'table'),

-- b2 (19-21) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (7.5,8.25,9,9.75,10.5)
('H.b2', 'TMP-wfgkuwyf', 'H(b2)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 19, true, '', 'b2', 'table'),
('C.b2', 'TMP-wfgkuwyf', 'C(b2)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 20, true, '', 'b2', 'table'),
('T.b2', 'TMP-wfgkuwyf', 'T(b2)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 21, true, '', 'b2', 'table'),

-- b4 (22-24) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (7.5,8.25,9,9.75,10.5)
('H.b4', 'TMP-wfgkuwyf', 'H(b4)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 22, true, '', 'b4', 'table'),
('C.b4', 'TMP-wfgkuwyf', 'C(b4)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 23, true, '', 'b4', 'table'),
('T.b4', 'TMP-wfgkuwyf', 'T(b4)', 'number', 7.5, 8.25, 9, 9.75, 10.5, NULL, 24, true, '', 'b4', 'table'),
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b1', 4),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b2', 5),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b3', 6),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Flange Thickness', 'b4', 7),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Web Off Center', 'b1-b2/2', 8),  -- TETAP: perhitungan offset
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfgkuwyf', 'Web Off Center', 'b3-b4/2', 9),  -- TETAP: perhitungan offset
