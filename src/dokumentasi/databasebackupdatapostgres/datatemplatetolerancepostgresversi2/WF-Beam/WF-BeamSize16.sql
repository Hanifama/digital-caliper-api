...
-- b1 (13-15) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (13-15)
('H.b1','TMP-wfpgfdbh','H(b1)','number',13,13.5,14,14.5,15,NULL,13,true,NULL,'b1','table'),
('C.b1','TMP-wfpgfdbh','C(b1)','number',13,13.5,14,14.5,15,NULL,14,true,NULL,'b1','table'),
('T.b1','TMP-wfpgfdbh','T(b1)','number',13,13.5,14,14.5,15,NULL,15,true,NULL,'b1','table'),

-- b3 (16-18) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (13-15)
('H.b3','TMP-wfpgfdbh','H(b3)','number',13,13.5,14,14.5,15,NULL,16,true,NULL,'b3','table'),
('C.b3','TMP-wfpgfdbh','C(b3)','number',13,13.5,14,14.5,15,NULL,17,true,NULL,'b3','table'),
('T.b3','TMP-wfpgfdbh','T(b3)','number',13,13.5,14,14.5,15,NULL,18,true,NULL,'b3','table'),

-- b2 (19-21) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (13-15)
('H.b2','TMP-wfpgfdbh','H(b2)','number',13,13.5,14,14.5,15,NULL,19,true,NULL,'b2','table'),
('C.b2','TMP-wfpgfdbh','C(b2)','number',13,13.5,14,14.5,15,NULL,20,true,NULL,'b2','table'),
('T.b2','TMP-wfpgfdbh','T(b2)','number',13,13.5,14,14.5,15,NULL,21,true,NULL,'b2','table'),

-- b4 (22-24) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (13-15)
('H.b4','TMP-wfpgfdbh','H(b4)','number',13,13.5,14,14.5,15,NULL,22,true,NULL,'b4','table'),
('C.b4','TMP-wfpgfdbh','C(b4)','number',13,13.5,14,14.5,15,NULL,23,true,NULL,'b4','table'),
('T.b4','TMP-wfpgfdbh','T(b4)','number',13,13.5,14,14.5,15,NULL,24,true,NULL,'b4','table'),
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Width of Web', 'H-Top', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Width of Web', 'H-Bottom', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Height of Flange', 'B1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Height of Flange', 'B2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 't1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 't2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 't3', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 't4', 7), -- diubah dari 3 ke 7
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Web Thickness', 't6', 1), -- t6 order_numb NULL (sesuai data)
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Web Thickness', 't7', 2), -- t7 order_numb NULL (sesuai data)
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Web Off Center', 'b1-b2/2', 0), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Web Off Center', 'b3-b4/2', 1), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Radius', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'CoW', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'OS', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfpgfdbh', 'Unit Weight (Kgm)', '', 0);