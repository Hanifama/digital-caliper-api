...
('H.b1','TMP-wfjnxzbi','H(b1)','number',7.5,8.25,9,9.75,10.5,NULL,13,true,NULL,'b1','table'),
('C.b1','TMP-wfjnxzbi','C(b1)','number',7.5,8.25,9,9.75,10.5,NULL,14,true,NULL,'b1','table'),
('T.b1','TMP-wfjnxzbi','T(b1)','number',7.5,8.25,9,9.75,10.5,NULL,15,true,NULL,'b1','table'),

-- b3 (16-18) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (7.5-10.5)
('H.b3','TMP-wfjnxzbi','H(b3)','number',7.5,8.25,9,9.75,10.5,NULL,16,true,NULL,'b3','table'),
('C.b3','TMP-wfjnxzbi','C(b3)','number',7.5,8.25,9,9.75,10.5,NULL,17,true,NULL,'b3','table'),
('T.b3','TMP-wfjnxzbi','T(b3)','number',7.5,8.25,9,9.75,10.5,NULL,18,true,NULL,'b3','table'),

-- b2 (19-21) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (7.5-10.5)
('H.b2','TMP-wfjnxzbi','H(b2)','number',7.5,8.25,9,9.75,10.5,NULL,19,true,NULL,'b2','table'),
('C.b2','TMP-wfjnxzbi','C(b2)','number',7.5,8.25,9,9.75,10.5,NULL,20,true,NULL,'b2','table'),
('T.b2','TMP-wfjnxzbi','T(b2)','number',7.5,8.25,9,9.75,10.5,NULL,21,true,NULL,'b2','table'),

-- b4 (22-24) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (7.5-10.5)
('H.b4','TMP-wfjnxzbi','H(b4)','number',7.5,8.25,9,9.75,10.5,NULL,22,true,NULL,'b4','table'),
('C.b4','TMP-wfjnxzbi','C(b4)','number',7.5,8.25,9,9.75,10.5,NULL,23,true,NULL,'b4','table'),
('T.b4','TMP-wfjnxzbi','T(b4)','number',7.5,8.25,9,9.75,10.5,NULL,24,true,NULL,'b4','table'),
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Width of Web', 'H-Top', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Width of Web', 'H-Bottom', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Height of Flange', 'B1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Height of Flange', 'B2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 't1', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 't2', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 't3', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 't4', 7), -- diubah dari 3 ke 7
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Web Thickness', 't6', 1),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Web Thickness', 't7', 2),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Web Off Center', 'b1-b2/2', 0), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Web Off Center', 'b3-b4/2', 1), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Radius', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'CoW', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'OS', '', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfjnxzbi', 'Unit Weight', '', 0);