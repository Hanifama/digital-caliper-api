...
-- b1 (13-15) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (5.5,6.25,7,7.75,8.5)
...
-- b3 (16-18) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (5.5,6.25,7,7.75,8.5)
...
-- b2 (19-21) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (5.5,6.25,7,7.75,8.5)
...
-- b4 (22-24) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (5.5,6.25,7,7.75,8.5)
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Flange Thickness', 'b1', 4),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Flange Thickness', 'b2', 5),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Flange Thickness', 'b3', 6),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Flange Thickness', 'b4', 7),  -- DIUBAH
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Web Off Center', 'b1-b2/2', 8),  -- TETAP: perhitungan offset
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfeiswvd', 'Web Off Center', 'b3-b4/2', 9),  -- TETAP: perhitungan offset
