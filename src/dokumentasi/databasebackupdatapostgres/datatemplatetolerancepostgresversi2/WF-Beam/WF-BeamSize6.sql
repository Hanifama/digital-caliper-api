...
('H.b1', 'TMP-wffjtxwe', 'H(b1)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 13, true, '', 'b1', 'table'),
('C.b1', 'TMP-wffjtxwe', 'C(b1)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 14, true, '', 'b1', 'table'),
('T.b1', 'TMP-wffjtxwe', 'T(b1)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 15, true, '', 'b1', 'table'),

-- b3 (16-18) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (6.5-9.5)
('H.b3', 'TMP-wffjtxwe', 'H(b3)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 16, true, '', 'b3', 'table'),
('C.b3', 'TMP-wffjtxwe', 'C(b3)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 17, true, '', 'b3', 'table'),
('T.b3', 'TMP-wffjtxwe', 'T(b3)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 18, true, '', 'b3', 'table'),

-- b2 (19-21) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (6.5-9.5)
('H.b2', 'TMP-wffjtxwe', 'H(b2)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 19, true, '', 'b2', 'table'),
('C.b2', 'TMP-wffjtxwe', 'C(b2)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 20, true, '', 'b2', 'table'),
('T.b2', 'TMP-wffjtxwe', 'T(b2)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 21, true, '', 'b2', 'table'),

-- b4 (22-24) - PERHATIAN: tolerance diubah dari Web Off Center (-2.5-2.5) ke Flange Thickness (6.5-9.5)
('H.b4', 'TMP-wffjtxwe', 'H(b4)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 22, true, '', 'b4', 'table'),
('C.b4', 'TMP-wffjtxwe', 'C(b4)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 23, true, '', 'b4', 'table'),
('T.b4', 'TMP-wffjtxwe', 'T(b4)', 'number', 6.5, 7.25, 8, 8.75, 9.5, NULL, 24, true, '', 'b4', 'table'),
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 't4', 7), -- diubah dari 3 ke 7
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Thickness', 't6', 1), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Thickness', 't7', 2), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Off Center', 'b1-b2/2', 0), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Off Center', 'b3-b4/2', 1), -- order_numb disesuaikan
