...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 't4', 7), 
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b1', 3),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b2', 4),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b3', 5),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Flange Thickness', 'b4', 6),  
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Off Center', 'b1-b2/2', 0), 
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wffjtxwe', 'Web Off Center', 'b3-b4/2', 1), 
