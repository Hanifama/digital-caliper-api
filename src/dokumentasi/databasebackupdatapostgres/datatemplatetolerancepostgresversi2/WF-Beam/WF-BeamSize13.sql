...
-- b1 (13-15) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (10.5,11.25,12,12.75,13.5)
...
-- b3 (16-18) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (10.5,11.25,12,12.75,13.5)
...
-- b2 (19-21) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (10.5,11.25,12,12.75,13.5)
...
-- b4 (22-24) - PERUBAHAN: tolerance diubah mengikuti Flange Thickness (10.5,11.25,12,12.75,13.5)
...
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Flange Thickness', 'b1', 4),  -- DIUBAH
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Flange Thickness', 'b2', 5),  -- DIUBAH
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Flange Thickness', 'b3', 6),  -- DIUBAH
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Flange Thickness', 'b4', 7),  -- DIUBAH
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b1-b2/2', 8),  -- TETAP: perhitungan offset
('MAP' || LEFT(gen_random_uuid()::text, 8), 'TMP-wfmpcade', 'Web Off Center', 'b3-b4/2', 9),  -- TETAP: perhitungan offset
