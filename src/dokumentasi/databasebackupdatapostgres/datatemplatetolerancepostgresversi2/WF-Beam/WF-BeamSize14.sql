...
-- b1 (13-15) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (7.5-10.5)
...
-- b3 (16-18) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (7.5-10.5)
...
-- b2 (19-21) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (7.5-10.5)
...
-- b4 (22-24) - PERHATIAN: tolerance diubah dari Web Off Center (-3.5-3.5) ke Flange Thickness (7.5-10.5)
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Flange Thickness', 't4', 7), -- diubah dari 3 ke 7
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Web Thickness', 't5', 0),
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Web Thickness', 't6', 1), -- t6 order_numb NULL (sesuai data)
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Web Thickness', 't7', 2), -- t7 order_numb NULL (sesuai data)
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Web Off Center', 'b1-b2/2', 0), -- order_numb disesuaikan
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfnddbef', 'Web Off Center', 'b3-b4/2', 1), -- order_numb disesuaikan
