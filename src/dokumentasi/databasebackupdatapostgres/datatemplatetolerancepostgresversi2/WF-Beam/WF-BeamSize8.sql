...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 't4', 7), 
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 'b1', 3),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 'b2', 4),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 'b3', 5),  
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Flange Thickness', 'b4', 6),  
...
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b1-b2/2', 0), 
(concat('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-wfhlvxzg', 'Web Off Center', 'b3-b4/2', 1), 
