...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Flange Thickness', 'b1', 4), 
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Flange Thickness', 'b2', 5),  
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Flange Thickness', 'b3', 6),  
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Flange Thickness', 'b4', 7), 
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Web Off Center', 'b1-b2/2', 8), 
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuze', 'Web Off Center', 'b3-b4/2', 9);  