...
-- b1 (13-15) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD (17.5,18.25,19,19.75,20.5)
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Flange Thickness', 'b1', 3),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Flange Thickness', 'b2', 4),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Flange Thickness', 'b3', 5),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxfdzb', 'Flange Thickness', 'b4', 6),  -- DIUBAH: dari Web Off Center ke Flange Thickness
