...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzz', 'Flange Thickness', 'b1', 3),  
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzz', 'Flange Thickness', 'b2', 4),  
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzz', 'Flange Thickness', 'b3', 5), 
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzz', 'Flange Thickness', 'b4', 6),  
