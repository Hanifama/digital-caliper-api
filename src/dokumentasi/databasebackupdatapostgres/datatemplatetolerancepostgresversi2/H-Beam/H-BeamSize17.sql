...
-- b1 (13-15) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD (19.5,20.25,21,21.75,22.5)
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzf', 'Flange Thickness', 'b1', 4),  -- DIUBAH: dari Web Off Center ke Flange Thickness
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzf', 'Flange Thickness', 'b2', 5),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzf', 'Flange Thickness', 'b3', 6),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzf', 'Flange Thickness', 'b4', 7),  -- DIUBAH: dari Web Off Center ke Flange Thickness
