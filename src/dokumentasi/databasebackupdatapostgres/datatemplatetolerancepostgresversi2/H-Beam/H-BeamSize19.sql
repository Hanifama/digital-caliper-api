...
-- b1 (13-15) - tolerance diubah dari 33.3-36.7 menjadi -3.5-3.5 (sesuai Web Off Center)
...
-- b3 (16-18) - tolerance diubah dari 33.3-36.7 menjadi -3.5-3.5 (sesuai Web Off Center)
...
-- b2 (19-21) - tolerance diubah dari 33.3-36.7 menjadi -3.5-3.5 (sesuai Web Off Center)
...
-- b4 (22-24) - tolerance diubah dari 33.3-36.7 menjadi -3.5-3.5 (sesuai Web Off Center)
...
-- Perubahan pada qc_template_mapping:
-- 1. b1, b2, b3, b4 dipindahkan dari "Web Off Center" ke "Flange Thickness"
-- 2. order_numb untuk b1-b4 disesuaikan agar berurutan di kelompok Flange Thickness
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Flange Thickness', 'b1', 3),  -- b1 dipindah ke Flange Thickness
...
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Flange Thickness', 'b2', 4),  -- b2 dipindah ke Flange Thickness
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Flange Thickness', 'b3', 5),  -- b3 dipindah ke Flange Thickness
(concat('MAP', left(gen_random_uuid()::text, 8)), 'TMP-rtxtuzh', 'Flange Thickness', 'b4', 6),  -- b4 dipindah ke Flange Thickness
