...
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 'b1', 3), -- DIUBAH: dari 'Web Off Center' ke 'Flange Thickness'
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 't1', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 'b2', 4), -- DIUBAH: dari 'Web Off Center' ke 'Flange Thickness'
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 'b3', 5), -- DIUBAH: dari 'Web Off Center' ke 'Flange Thickness'
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Width of Web', 'H-Top', 0),
(CONCAT('MAP', LEFT(gen_random_uuid()::text, 8)), 'TMP-rtxtuyt', 'Flange Thickness', 'b4', 6), -- DIUBAH: dari 'Web Off Center' ke 'Flange Thickness'
