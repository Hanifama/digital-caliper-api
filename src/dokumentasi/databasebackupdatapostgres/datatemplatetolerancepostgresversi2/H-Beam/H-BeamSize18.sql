...
-- b1 (13-15) - TOLERANCE DIUBAH: mengikuti Flange Thickness (26.3,27.15,28,28.85,29.7)
...
-- b3 (16-18) - TOLERANCE DIUBAH: mengikuti Flange Thickness (26.3,27.15,28,28.85,29.7)
...
-- b2 (19-21) - TOLERANCE DIUBAH: mengikuti Flange Thickness (26.3,27.15,28,28.85,29.7)
...
-- b4 (22-24) - TOLERANCE DIUBAH: mengikuti Flange Thickness (26.3,27.15,28,28.85,29.7)
...
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Flange Thickness', 'b1', 4),  -- DIUBAH: b1 mapping ke Flange Thickness
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Flange Thickness', 'b2', 5),  -- DIUBAH: b2 mapping ke Flange Thickness
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Flange Thickness', 'b3', 6),  -- DIUBAH: b3 mapping ke Flange Thickness
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Flange Thickness', 'b4', 7),  -- DIUBAH: b4 mapping ke Flange Thickness
...
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Web Off Center', 'b1-b2/2', 8),  -- Tetap di Web Off Center karena ini perhitungan offset
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzg', 'Web Off Center', 'b3-b4/2', 9); -- Tetap di Web Off Center karena ini perhitungan offset