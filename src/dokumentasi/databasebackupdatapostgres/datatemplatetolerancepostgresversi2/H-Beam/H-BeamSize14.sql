...
-- b1 (13-15) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
...
-- b3 (16-18) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
...
-- b2 (19-21) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
...
-- b4 (22-24) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
...
-- b1-b2/2 (25-27) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
('H.b1-b2/2','TMP-rtxtuzc','H(b1-b2/2)','number',14,14.5,15,15.5,16,NULL,25,true,'','b1-b2/2','table'),
('C.b1-b2/2','TMP-rtxtuzc','C(b1-b2/2)','number',14,14.5,15,15.5,16,NULL,26,true,'','b1-b2/2','table'),
('T.b1-b2/2','TMP-rtxtuzc','T(b1-b2/2)','number',14,14.5,15,15.5,16,NULL,27,true,'','b1-b2/2','table'),

-- b3-b4/2 (28-30) - TOLERANSI DIUBAH SESUAI FLANGE THICKNESS (14-16)
('H.b3-b4/2','TMP-rtxtuzc','H(b3-b4/2)','number',14,14.5,15,15.5,16,NULL,28,true,'','b3-b4/2','table'),
('C.b3-b4/2','TMP-rtxtuzc','C(b3-b4/2)','number',14,14.5,15,15.5,16,NULL,29,true,'','b3-b4/2','table'),
('T.b3-b4/2','TMP-rtxtuzc','T(b3-b4/2)','number',14,14.5,15,15.5,16,NULL,30,true,'','b3-b4/2','table'),
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b1', 3),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b2', 4),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b3', 5),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b4', 6),  -- DIUBAH: dari Web Off Center ke Flange Thickness
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b1-b2/2', 7),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzc', 'Flange Thickness', 'b3-b4/2', 8),  -- DIUBAH: dari Web Off Center ke Flange Thickness
