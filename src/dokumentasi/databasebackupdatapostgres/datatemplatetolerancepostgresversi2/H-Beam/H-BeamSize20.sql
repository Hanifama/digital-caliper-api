...
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Flange Thickness', 'b1', 4),  
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Flange Thickness', 'b2', 5),  
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Flange Thickness', 'b3', 6), 
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Flange Thickness', 'b4', 7),  
...
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Web Off Center', 'b1-b2/2', 8), 
('MAP' || LEFT(md5(random()::text), 8), 'TMP-rtxtuzi', 'Web Off Center', 'b3-b4/2', 9); 