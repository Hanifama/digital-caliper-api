...
-- b1 (13-15) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD (16.5,17.25,18,18.75,19.5)
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzd', 'Flange Thickness', 'b1', 4),  -- DIUBAH: dari Web Off Center ke Flange Thickness
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzd', 'Flange Thickness', 'b2', 5),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzd', 'Flange Thickness', 'b3', 6),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuzd', 'Flange Thickness', 'b4', 7),  -- DIUBAH: dari Web Off Center ke Flange Thickness
