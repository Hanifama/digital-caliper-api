...
-- b1 (13-15) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD (11,11.5,12,12.5,13)
('H.b1','TMP-rtxtuyu','H(b1)','number',11,11.5,12,12.5,13,NULL,13,true,'','b1','table'),
('C.b1','TMP-rtxtuyu','C(b1)','number',11,11.5,12,12.5,13,NULL,14,true,'','b1','table'),
('T.b1','TMP-rtxtuyu','T(b1)','number',11,11.5,12,12.5,13,NULL,15,true,'','b1','table'),

-- b3 (16-18) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD
('H.b3','TMP-rtxtuyu','H(b3)','number',11,11.5,12,12.5,13,NULL,16,true,'','b3','table'),
('C.b3','TMP-rtxtuyu','C(b3)','number',11,11.5,12,12.5,13,NULL,17,true,'','b3','table'),
('T.b3','TMP-rtxtuyu','T(b3)','number',11,11.5,12,12.5,13,NULL,18,true,'','b3','table'),

-- b2 (19-21) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD
('H.b2','TMP-rtxtuyu','H(b2)','number',11,11.5,12,12.5,13,NULL,19,true,'','b2','table'),
('C.b2','TMP-rtxtuyu','C(b2)','number',11,11.5,12,12.5,13,NULL,20,true,'','b2','table'),
('T.b2','TMP-rtxtuyu','T(b2)','number',11,11.5,12,12.5,13,NULL,21,true,'','b2','table'),

-- b4 (22-24) - TOLERANSI DIUBAH KE FLANGE THICKNESS STANDARD
('H.b4','TMP-rtxtuyu','H(b4)','number',11,11.5,12,12.5,13,NULL,22,true,'','b4','table'),
('C.b4','TMP-rtxtuyu','C(b4)','number',11,11.5,12,12.5,13,NULL,23,true,'','b4','table'),
('T.b4','TMP-rtxtuyu','T(b4)','number',11,11.5,12,12.5,13,NULL,24,true,'','b4','table'),
...
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Width of Web', 'H-Bottom', 1),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 't4', 2),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 'b1', 3),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 't1', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 'b2', 4),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 'b3', 5),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Width of Web', 'H-Top', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 'b4', 6),  -- DIUBAH: dari Web Off Center ke Flange Thickness
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 't2', 1),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Height of Flange', 'B2', 1),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'OS', '', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Flange Thickness', 't3', 2),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Radius', '', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Unit Weight (Kgm)', '', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Height of Flange', 'B1', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'CoW', '', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Web Thickness', 't5', 0),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Web Off Center', 'b1-b2/2', 7),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Web Off Center', 'b3-b4/2', 8),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Web Thickness', 't6', 9),
('MAP' || LEFT(REPLACE(gen_random_uuid()::text, '-', ''), 8), 'TMP-rtxtuyu', 'Web Thickness', 't7', 10);